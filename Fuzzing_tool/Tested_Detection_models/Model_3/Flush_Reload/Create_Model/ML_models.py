...
# Read Data
data_path='D:\CPR Research\Topic8. Adversarial_attack\myversion\Fuzzing_tool\Tested_Detection_models\Model_3\Flush_Reload\Create_Model\Processed_Data'
...
def dt_model(x_train, y_train, x_test):
    dt_model = DecisionTreeClassifier(random_state=1).fit(x_train,y_train['y'])
    # Prediction
