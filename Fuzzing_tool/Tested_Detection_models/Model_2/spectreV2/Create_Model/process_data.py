...
# Data path
num_sample = 50
benign_data_path = 'D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool/Tested_Detection_models/Model_2/spectreV2/Create_Model/Processed_Data/benign'
...
processed_data_path = 'D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool/Tested_Detection_models/Model_2/spectreV2/Create_Model/Processed_Data/FinalData'
...
attack_data_path = 'D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool/Tested_Detection_models/Model_2/spectreV2/Create_Model/Processed_Data/attack'
...
df_specv2 = pd.read_csv(os.path.join(attack_data_path, attack_file_name_specv2), header=None)
...
X = pd.concat([X, df_spec_v2])
Y = pd.concat([Y, pd.DataFrame(np.ones(df_spec_v2.shape[0]))])  
