...
#  2.00         Debopriya 6/15/2024  Updated with new Detection Models
#  
###############################################################################################
...
sys.path.insert(0,'D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/Tested_Detection_models')
...
class ModuleTester:
    ...
    def fuzz_Module(self, initial_value, increment, experiment_name):
        ...
        self.local_collecteddata_folder = f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/Tested_Detection_models/{self.model_name}/{self.attack_name}/Test_Data"
        ...
        self.local_spectre_path = f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/targeted_attacks/{self.attack_name}/spectre.c"
        self.local_flush_reload_path = f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/targeted_attacks/{self.attack_name}/newspy.cpp"
