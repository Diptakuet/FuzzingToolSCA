...
class DetectionModel_4:
    ...
    def __init__(self,test_file_name, experiment_name,attack_name):
        ...
        # for accuracy check
        #data_path = 'D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/Tested_Detection_models/Model_4/Create_Model/Processed_Data'
    ...
    # Buliding cnn model
    def cnn_model(self):
        model_path=f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Systematic_fuzzing/Tested_Detection_models/Model_4/{self.attack_name}/Create_Model/Processed_Data"
        x_train = (self.x_train-self.x_train.mean())/self.x_train.std()
        x_test = (self.x_test-self.x_train.mean())/self.x_train.std()
