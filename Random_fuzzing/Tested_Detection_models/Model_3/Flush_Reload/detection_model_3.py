...
class DetectionModel_3:
    ...
    def __init__(self,test_file_name, attack_name):
        ...
        data_path = f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Random_fuzzing/Tested_Detection_models/Model_3/{attack_name}"
        self.model_path=f"D:/CPR Research/Topic8. Adversarial_attack/FinalWorkDir/Random_fuzzing/Tested_Detection_models/Model_3/{attack_name}/Create_Model/Processed_Data/Model_{attack_name}.h5"
        # for accuracy check
