...
class DetectionModel_4_spectre2:
    ...
    def __init__(self,test_file_name, attack_name):
        data_path = f"D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool_version_2/Tested_Detection_models/Model_4/{attack_name}"
        self.model_path=f"D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool_version_2/Tested_Detection_models/Model_4/{attack_name}/Create_Model/Processed_Data/Model_{attack_name}.h5"
        # for accuracy check
        #data_path = f"D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool/Tested_Detection_models/Model_4/{attack_name}/Create_Model/Processed_Data"
    ...
    # Buliding cnn model
    def cnn_model(self):
        #model_path=f"D:/CPR Research/Topic8. Adversarial_attack/myversion/Fuzzing_tool/Tested_Detection_models/Model_4/{attack_name}/Create_Model/Processed_Data"
        x_train = (self.x_train-self.x_train.mean())/self.x_train.std()
        x_test = (self.x_test-self.x_train.mean())/self.x_train.std()
